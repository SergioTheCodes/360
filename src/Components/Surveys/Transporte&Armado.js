...
class Transporte_y_Armado extends React.Component {
    ...
    componentDidMount() {
        const options ={
            ...
            html: `     <p>Hola</p>
                        ...
                        Ayúdanos a mejorar solamente con dos preguntas haciendo click <a href="http://tugo.harcorp.com.co/TransporteyArmado">aquí:</a>
...
export default Transporte_y_Armado;
